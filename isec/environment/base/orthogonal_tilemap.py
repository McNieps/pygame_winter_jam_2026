...
class OrthogonalTilemap:
    ...
    @classmethod
    def create_tileset_from_surface(cls,
        ...
        tile_index_offset = cls.EMPTY_TILE + 1

        for i in range(nb_rows):
            for j in range(nb_columns):
                tile_index = i*nb_columns+j + tile_index_offset
                tileset[tile_index] = tileset_surface.subsurface(
