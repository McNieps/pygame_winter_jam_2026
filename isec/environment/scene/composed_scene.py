...
from isec.environment.base import Entity, OrthogonalTilemap
...
class ComposedScene(Scene):
    def __init__(self,
        ...
        self.tilemap_scenes: list[OrthogonalTilemapScene] = []
    ...
    def add_tilemap_scene(self,
                          tilemap: OrthogonalTilemap) -> None:
        """
        ...
        new_tilemap_scene = OrthogonalTilemapScene(tilemap, surface=self.surface, camera=self.camera)
